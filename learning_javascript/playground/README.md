...
*   **`main.js`**: The main script file. Here, we import and execute the modules we are studying. 🚀

### 🚀 How to Use
1.  Open the `index.html` file in your preferred browser.
2.  Edit the `main.js` file to import specific files from the `theoretical_content` folder or to write your own test code.
...
*   **`main.js`**: O arquivo de script principal. Aqui, importamos e executamos os módulos que estamos estudando. 🚀

### 🚀 Como Usar
1.  Abra o arquivo `index.html` no seu navegador preferido.
2.  Edite o arquivo `main.js` para importar arquivos específicos da pasta `theoretical_content` ou para escrever seus próprios códigos de teste.
